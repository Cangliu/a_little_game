...
【输出示例】
{{"chosen": 3, "narrative": "你在山间修炼时...", "has_choice": true, "branches": [{{"text": "拔剑迎战", "effects": {{"cultivation": 20, "constitution": -1}}, "result_text": "你挺身而出...", "consequence_tag": "勇名远播", "consequence_desc": "你的勇武之名在修仙界传开"}}, {{"text": "暗中观察", "effects": {{"comprehension": 1}}, "result_text": "你按捺住冲动...", "consequence_tag": "", "consequence_desc": ""}}]}}"""
