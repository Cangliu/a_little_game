...
- 格式: {{"chosen": 编号(1开始), "narrative": "叙事文本", "has_choice": bool, "branches": [分支数组]或null, "combat_loot": null或{{"name": "物品名", "category": "分类", "desc": "描述", "power": 数字}}, "causal_chain": null或{{"cause": "...", "expected_resolution": "...", "keywords": [...]}}, "emotional_token": null或{{"name": "...", "description": "...", "source_npc": "...", "keywords": [...]}}}}
...
1. **danger+combat事件→战后缴获**：
   ...
   - 若叙事中角色胜出或险胜，可输出"combat_loot"字段，从【当前可获得的修行资源】中选取1个作为战利品
   - combat_loot格式: {{"name": "物品名", "category": "分类", "desc": "描述", "power": 数字}}
   - 叙事应包含缴获过程（"从对方储物袋中翻出...""对方遗落一枚..."）
   - 不是每次combat都有战利品，约40%的combat事件适合输出combat_loot
   - 若叙事中角色落败/勉强逃脱，则不输出此字段
...
【输出示例】
{{"chosen": 3, "narrative": "你在山间修炼时...", "has_choice": true, "branches": [{{"text": "拔剑迎战", "effects": {{"cultivation": 20, "constitution": -1}}, "result_text": "你挺身而出...", "consequence_tag": "勇名远播", "consequence_desc": "你的勇武之名在修仙界传开"}}], "combat_loot": {{"name": "寒冰珠", "category": "treasure", "desc": "可凝聚寒气护体", "power": 2}}, "causal_chain": {{"cause": "师父身受重伤飘然而去", "expected_resolution": "寻找救治师父的方法", "keywords": ["师父", "重伤", "救治", "寻找"]}}}}"""
